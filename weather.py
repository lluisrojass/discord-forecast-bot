...
def _format_data(weather_data: dict):
    ...
    units_distance,units_pressure,units_temp,units_speed = ''
    forecast_status, forecast_date, forecast_day, forecast_tlow ,forecast_thigh, forecast , \
    tom_status, tom_date, tom_day, tom_tlow, tom_thigh, \
    wind,wind_chill,wind_speed, \
    humidity,pressure,atmosphere,visibility, \
    astronomy,sunrise,sunset = 'N/A'
